                ...
                <div class="moreColor">
                    ...
                    <div style="text-align: right">
                        <a-tooltip content="动态背景颜色">
                            <span class="colorItem" style="background-color: var(--color-bg-1);"
                                  @click="updateColor('var(--color-bg-1)')"></span>
                        </a-tooltip>
                        <a-tooltip content="动态文字颜色">
                            <span class="colorItem" style="background-color: var(--color-text-1)"
                                  @click="updateColor('var(--color-text-1)')"></span>
                        </a-tooltip>
                    </div>
                </div>
            </div>
