...
export function openFormulaDrawer() {
    Drawer.open({
        ...
        content: () => <Typography>
            ...
            <TypographyTitle heading={1} style="text-align: start;">内置函数</TypographyTitle>
            <TypographyTitle heading={2} style="text-align: start;">使用方法</TypographyTitle>
            <TypographyParagraph>
                例如，我要计算一列的和：
                <pre>=SUM(G:G)</pre>
            </TypographyParagraph>
            <TypographyTitle heading={2} style="text-align: start;">概述</TypographyTitle>
