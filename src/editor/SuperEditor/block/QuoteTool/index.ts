...
export default class Quote implements BlockTool {
  ...
  public render(): HTMLElement {
    const container = makeElement('blockquote', [
      this.css.baseClass,
      this.css.wrapper,
    ]);
    const quote = makeElement('div', [this.css.input, this.css.text], {
      contentEditable: !this.readOnly,
      innerHTML: this.data.text,
    });
    const caption = makeElement('div', [this.css.input, this.css.caption], {
      contentEditable: !this.readOnly,
