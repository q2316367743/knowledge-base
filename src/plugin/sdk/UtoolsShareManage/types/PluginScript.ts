...
/**
 * PluginScriptHistoryItem
 */
export interface PluginScriptHistoryItem {
    /**
     * 下载数量
     */
...
/**
 * PluginScriptHistorySelfItem
 */
export interface PluginScriptHistorySelfItem extends PluginScriptHistoryItem{
    /**
     * 审核状态
     */
    verityStatus?: number | null;
}
