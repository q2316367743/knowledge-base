...
!function () {
    ...
    var _ = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
        ...
        var d, u, a = 0, s = c.document, l = /^(?:text|application)\/javascript/i, p = /^(?:text|application)\/xml/i,
            f = "application/json", g = "text/html", m = /^\s*$/, v = function e(t) {
                var o = A({}, t || {});
                ...
                var r = o.dataType, t = /=\?/.test(o.url);
                if ("jsonp" == r || t) return t || (o.url = P(o.url, "callback=?")), e.JSONP(o);
                o.url || (o.url = c.location.toString()), D(o);
                var i, n = o.accepts[r], t = {}, a = /^([\w-]+:)\/\//.test(o.url) ? RegExp.$1 : c.location.protocol,
                    s = e.settings.xhr();
        ...
        v.active = 0, v.JSONP = function (t) {
            ...
            var n, o = "jsonp" + ++a, e = s.createElement("script"), r = {
                abort: function () {
            ...
            return v({url: e, success: t, dataType: "json"})
        };
        ...
        msgs: []
    }, r = {type: 2, data: {id: "", start: 0, duration: 0}}, l = {autoTrack: !0};
    !function () {
    ...
    var p = (new Date).getTime(), e = function (e, t, n) {
    ...
    l.localStorage = {
        add: function (e, t) {
            ...
            this.cookieList();
            t("__TD_LOCAL", "", {expires: 1095, path: "/", domain: location.hostname})
        }, _addCookie: function (e) {
            t("__TD_LOCAL", e, {expires: 1095, path: "/", domain: location.hostname})
        }, _getCookie: function (e) {
            const t = this.cookieList();
            if (t && t[e]) return t[e]
        }, delCookie: function (e) {
        }, cookieList: function () {
            const e = t("__TD_LOCAL");
            return this.format(e)
        }, addLocalStorage: function (e, t) {
            if ("sessionId" === e) {
                sessionStorage.setItem("__TD_" + e, t)
            }else {
                window.storage.setItem("__TD_" + e, t);
            }
            ...
            if ( "sessionId" === e) {
                ...
                return window.storage.getItem("__TD_" + e)
            }
        }, format: function (e) {
            const t = {};
            if (!e) return t;
            for (let n = e.split(";"), o = n.length, r = 0; r < o; r++) {
                const i = n[r].split("=");
    ...
    v.prototype = {
        getAjax: function (o, r, i, a, s) {
            ...
            })({url: this.url, type: "POST", param: JSON.stringify(i), success: a})
        }, set: function (e, t, n) {
        ...
        for (var e = new Object, t = i.location.search.substring(1).split("&"), n = 0; n < t.length; n++) {
            var o, r = t[n].indexOf("=");
            -1 != r && (o = t[n].substring(0, r), r = t[n].substring(r + 1), r = decodeURIComponent(r), e[o] = r)
        }
        return e
    }, TDBASE.getCommon = function (e) {
        var t = S.get("appkey") ? S.get("appkey") : u.appkey, e = {
            deviceId: u.deviceId,
            appkey: t,
        ...
        return {type: 2, data: {id: e, start: t, status: n, duration: o || 0, pages: i ? [i] : [], events: r || []}}
        ...
        if (S.get("sessionMsg")) {
            n && n(e);
            var n = JSON.parse(S.get("sessionMsg")), o = n.msg[n.msg.length - 1].data[t];
            if ("events" !== t) o.push(e), S.add("sessionMsg", JSON.stringify(n)); else {
                if (0 != o.length) {
                    for (var r = !1, i = 0; i < o.length; i++) if (TDBASE.equal(o[i], e)) {
        ...
        var t;
        S.get("sessionMsg") ? ((t = JSON.parse(S.get("sessionMsg"))).msg.push(e), S.add("sessionMsg", JSON.stringify(t))) : S.add("sessionMsg", JSON.stringify({msg: [e]}))
    }, (a = {
        currentPage: null, pageStartTime: 0, ref: "", logoutCalled: !1, init: function () {
            ...
            t = {name: e, start: n, duration: 0, refer: t || document.referrer};
    ...
    var S = l.localStorage, s = l.sessionStorage, T = {
        timedif: void 0, state: 1, deviceId: 0, sessionId: 0, local: [], sendInit: 0, set: function () {
            try {
            ...
            if (S.get("deviceId")) {
                ...
                let t = [];
                let e = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");
                let n = e.length;
                let o = 0;
                this.sendInit = 1;
                for (; o < 16; o++) t[o] = e[0 | Math.random() * n];

                if (window.utools) {
                    this.deviceId = utools.getNativeId();
                }else {
            ...
            var e, t;
            if (s.get("sessionId") && S.get("appkey") == u.appkey ? t = s.get("sessionId") : (e = (new Date).getTime(), t = -1 < this.deviceId.indexOf("-") ? this.deviceId.split("-")[0] + e : this.deviceId + e, this.sendInit = 0 == this.sendInit ? 2 : this.sendInit, s.add("sessionId", t)), 0 < 32 - t.length) for (var n = 0, o = 32 - t.length; n < o; n++) t += "0";
            ...
            var e = s.get("td_channel"), t = TDBASE.getArgs().td_channelid;
            ...
            var o, r = JSON.parse(S.get("sessionMsg")), i = TDBASE.getCommon(r), a = localStorage["__TD_td-init-event"];
        ...
        set: function (e, t, n, o) {
            ...
            if (e || /0{1}/.test(e)) {
                if (0 < arguments.length) try {
                    var i = {count: 1, start: (new Date).getTime()};
            ...
            e = {count: 1, start: (new Date).getTime(), domain: "account", id: t, params: e};
            y._saveAndFetch(e)
        }, _saveAndFetch: function (e) {
            d ? TDBASE.addGenre(e, "events", function (e) {
                var t = S.get("td-hold-event"), n = [];
                if (n.push(e), t) {
                    t = JSON.parse(t);
                    for (var o = 0; o < t.length; o++) if (TDBASE.equal(t[o], e)) {
